...
const MARKETPLACE_CATEGORIES = [
    'FURNITURE','ELECTRONICS','BUILDING_MATERIALS','APPLIANCES','OFFICE_SPACE',
    'BUSINESS_SPACE','STUDENT_HOSTEL','SHORTLET','EVENT_VENUE','WEDDING_MATERIALS',
    'RENT_TO_OWN','BUY_PROPERTIES','SALES_PROPERTIES','PROPERTY_MANAGEMENT',
];
